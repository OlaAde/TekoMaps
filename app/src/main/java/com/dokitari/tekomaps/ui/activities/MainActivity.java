...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, IMyLocationProvider {
    ...
    private void setupMap() {
        ...
        MyLocationNewOverlay oMapLocationOverlay = new MyLocationNewOverlay(this, mMapView);
        mMapView.getOverlays().add(oMapLocationOverlay);
...
//            mMapView.getController().setCenter(new GeoPoint(mLastLocation.getLatitude(), mLastLocation.getLongitude()));
//        } else {
